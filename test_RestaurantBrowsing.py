...
class RestaurantDatabase:
    ...
    Attributes:
        restaurants (list): A list of dictionaries, where each dictionary represents a restaurant with
                            fields like name, cuisine, location, rating, price range, delivery status, and dishes.
    """
        ...
        self.restaurants = [
            {
                ...
                "price_range": "$$",
                "delivery": True,
                "dishes": ["Spaghetti Carbonara", "Margherita Pizza"]
            },
            {
                "name": "Sushi House",
                "cuisine": "Japanese",
                ...
                "price_range": "$$$",
                "delivery": False,
                "dishes": ["Sashimi Platter", "California Roll"]
            },
            {
                "name": "Burger King",
                "cuisine": "Fast Food",
                ...
                "price_range": "$",
                "delivery": True,
                "dishes": ["Whopper", "Crispy Chicken Sandwich"]
            },
            {
                "name": "Taco Town",
                "cuisine": "Mexican",
                ...
                "price_range": "$",
                "delivery": True,
                "dishes": ["Beef Tacos", "Chicken Quesadilla"]
            },
            {
                "name": "Pizza Palace",
                "cuisine": "Italian",
                ...
                "price_range": "$$",
                "delivery": True,
                "dishes": ["Pepperoni Pizza", "Veggie Delight"]
            }
        ]
